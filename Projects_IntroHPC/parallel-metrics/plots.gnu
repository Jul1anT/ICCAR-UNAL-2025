...
plot 'data/combined.txt' u 1:5 w lp ls 1 t "Paralela (par)", \
...
plot 'data/combined.txt' u 1:7 w lp ls 1, \
     '' u 1:8 w lp ls 2, \
     1 w l ls 3 t "Ideal"
...
stats 'data/combined.txt' u 2 nooutput
set arrow from cores,STATS_min to cores,STATS_max nohead ls 4

plot 'data/combined.txt' u 1:2 w lp ls 5 t "Secuencial", \
...
plot 'data/combined.txt' u 5:3 w p ls 1, \
     '' u 6:4 w p ls 2
